...
## List versions
aws s3api list-object-versions --bucket <BUCKET_NAME> --query "Versions[].VersionId"
...
aws s3api get-object --bucket <BUCKET_NAME> --key test.txt outfile --version-id abc123... && cat outfile

## Get null version (pre-versioning)
aws s3api get-object --bucket <BUCKET_NAME> --key test.txt outfile --version-id null && cat outfile
...
aws s3api delete-object --bucket <BUCKET_NAME> --key test.txt --version-id abc123...
